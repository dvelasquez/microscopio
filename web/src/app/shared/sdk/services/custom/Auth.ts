...
export class AuthApi extends BaseLoopBackApi {
  ...
  /**
   * Statistical information for Auth registers.
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/Auths" + "/:id";
   ...
   * call to {@link sdk.Auth#login} or
   * {@link sdk.Auth#getCurrent}. Return null when there
